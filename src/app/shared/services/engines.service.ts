...
export class EnginesService {
  ...
  public get(company: number, subdivision: number, car: number, resync = false): Observable<any> {
    if (resync) {
      this.http.get(this.host + '/v1/companies/' + company + '/subdivisions/' + subdivision + '/cars/' + car + '/engine')
  ...
  public getBase(company: number, subdivision: number, car: number): Observable<BaseEngine> {
    return this.http.get(this.host + '/v1/companies/' + company + '/subdivisions/' + subdivision + '/cars/' + car + '/engine')
      .map((response: any) => {
